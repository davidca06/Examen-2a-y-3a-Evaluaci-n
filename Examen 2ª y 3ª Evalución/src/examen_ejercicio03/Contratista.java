...
public class Contratista extends Empleado implements IngresoEnCuenta, Empresa {
	...
	public void realizarIngreso(double cantidad) {
		...
		System.out.println("Ingreso en cuenta del contratista "+super.getNombre()+" "+super.getApellidos()+" de la cantidad de "+cantidad+"€ en concepto de nómina. A fecha de "+LocalDate.now());
